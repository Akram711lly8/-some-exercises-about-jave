...
public class Controller {
    ...
    public void readTrafficOffenceFile() throws FileNotFoundException {
        Scanner in= new Scanner(new File("C:\\Users\\HP\\Desktop\\Registration system traffic violations\\src\\file\\Vioation.txt"));
        while (in.hasNext())
        {
    ...
    public void writeTrafficOffenceFile() throws FileNotFoundException {
        PrintWriter writer=new PrintWriter(new File("\"C:\\\\Users\\\\HP\\\\Desktop\\\\Registration system traffic violations\\\\src\\\\file\\\\Vioation.txt"));
        int i=0;
        while (i<counter_TrafficOffence) {
